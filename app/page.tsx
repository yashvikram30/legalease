...
export default function LandingPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-800">
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            ...
            >
              <div className="space-y-2">
                <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none text-navy-900 dark:text-slate-100">
              ...
              <div className="flex flex-col gap-2 min-[400px]:flex-row">
                <Button asChild size="lg" className="bg-teal-600 hover:bg-teal-700 dark:bg-teal-500 dark:hover:bg-teal-600">
                  <Link href="/chat">
                    Get Started Free
                    <ArrowRight className="ml-2 h-4 w-4" />
                  </Link>
                </Button>
                <Button asChild variant="outline" size="lg" className="border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700">
            ...
            >
              <Image
                ...
                className="rounded-2xl shadow-lg dark:shadow-slate-800/50"
              />
            </motion.div>
          </div>
        </div>
      ...
      <section className="w-full py-12 md:py-16 bg-white dark:bg-slate-900">
        <div className="container px-4 md:px-6">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <h2 className="text-2xl font-bold tracking-tighter sm:text-3xl text-navy-900 dark:text-slate-100">Our Mission</h2>
      ...
      {/* Features */}
      <section className="w-full py-12 md:py-24 bg-slate-50 dark:bg-slate-800">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl text-navy-900 dark:text-slate-100">Core Features</h2>
          ...
          <div className="mx-auto grid gap-6 md:gap-8 sm:grid-cols-2 lg:grid-cols-3 items-stretch max-w-5xl pt-8 md:pt-12">
            {features.map((feature, index) => (
              ...
              >
                <Card className="h-full transition-all hover:shadow-lg dark:hover:shadow-slate-700/50 bg-white dark:bg-slate-700 border-slate-200 dark:border-slate-600">
                  <CardHeader>
                    <div className="p-2 rounded-full bg-blue-50 dark:bg-blue-900/30 w-fit mb-4">{feature.icon}</div>
                    <CardTitle className="text-xl text-slate-900 dark:text-slate-100">{feature.title}</CardTitle>
                    <CardDescription className="text-slate-700 dark:text-slate-300">{feature.description}</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <Button asChild variant="ghost" className="group text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-600">
      ...
      <section className="w-full py-12 md:py-24 bg-white dark:bg-slate-900">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl text-navy-900 dark:text-slate-100">What Our Users Say</h2>
              <p className="max-w-[700px] text-slate-700 dark:text-slate-300 md:text-xl">
      ...
      {/* CTA Section */}
      <section className="w-full py-12 md:py-24 bg-gradient-to-b from-slate-50 to-white dark:from-slate-800 dark:to-slate-900">
        <div className="container px-4 md:px-6">
          <motion.div
          ...
          >
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl text-navy-900 dark:text-slate-100">
